...
## Regression model
The task was to fit a regression model where exam points is the target dependent variable and there are 3 explanatory variables. The visual analysis of the highest correlation and linear regression show that model 3 is the best, which includes attitude, stra and age.
